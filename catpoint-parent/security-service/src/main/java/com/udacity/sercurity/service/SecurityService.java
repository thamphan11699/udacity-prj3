 ...
 *
 * <p>This is the class that should contain most of the business logic for our system, and it is the
...
public class SecurityService {
  ...
  public void setArmingStatus(ArmingStatus armingStatus) {
    if (catDetection && Objects.equals(ArmingStatus.ARMED_HOME, armingStatus)) {
      setAlarmStatus(AlarmStatus.ALARM);
    }

    if (Objects.equals(ArmingStatus.DISARMED, armingStatus)) {
  ...
  private void catDetected(Boolean cat) {
    ...
    if (cat && Objects.equals(ArmingStatus.ARMED_HOME, getArmingStatus())) {
      setAlarmStatus(AlarmStatus.ALARM);
    } else if (!cat && getAllSensorsFromStatus()) {
      setAlarmStatus(AlarmStatus.NO_ALARM);
    }
  ...
  private boolean getAllSensorsFromStatus() {
  ...
  public void changeSensorActivationStatus(Sensor sensor, Boolean active) {
    ...
    if (!Objects.equals(AlarmStatus.ALARM, actualAlarmStatus)) {
      if (active) {
  ...
  public void changeSensorActivationStatus(Sensor sensor) {
    ...
    if (Objects.equals(AlarmStatus.PENDING_ALARM, actualAlarmStatus) && !sensor.getActive()) {
      handleSensorDeactivated();
    } else if (Objects.equals(AlarmStatus.ALARM, actualAlarmStatus)
        && Objects.equals(ArmingStatus.DISARMED, actualArmingStatus)) {
      handleSensorDeactivated();
    }
    securityRepository.updateSensor(sensor);
  }
